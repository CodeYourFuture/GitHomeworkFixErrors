...
=======
Forking  is a process of creating a copy of a complete repository to the user’s GitHub Account from another account.
>>>>>>> Stashed changes
...
=======
It is a command used in Git to access the history of commits that the repository has gone through.
>>>>>>> Stashed changes
...
=======
To "Push" in GitHub means uploading to a GitHub repository.
>>>>>>> Stashed changes
